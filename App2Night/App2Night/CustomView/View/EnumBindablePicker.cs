...
namespace App2Night.CustomView.View
{
    ...
    public class EnumBindablePicker<T> : Picker where T : struct
    {
        ...
        public static BindableProperty SelectedItemProperty = BindableProperty.Create(nameof(SelectedItem), typeof(T),
            typeof(EnumBindablePicker<T>), default(T), propertyChanged: OnSelectedItemChanged,
